...
export const PIPELINE_STAGES: StageMeta[] = [
  ...
  },
  {
    id: "CONTACTED",
    label: "Contatado",
    description: "Primeira conversa realizada.",
    color: "var(--chart-1)",
  },
  {
    id: "VISIT_SCHEDULED",
    label: "Visita agendada",
    description: "Cliente confirmou presença na loja.",
    color: "var(--chart-6)",
  },
  {
    id: "NEGOTIATION",
    label: "Negociação",
    description: "Discutindo valores, troca e financiamento.",
    color: "var(--chart-4)",
  },
  {
    id: "PROPOSAL",
    label: "Proposta",
    description: "Proposta formal enviada, aguardando resposta.",
    color: "var(--chart-3)",
  },
  {
    id: "WON",
  ...
  },
  {
    id: "LOST",
    label: "Perdido",
    description: "Oportunidade encerrada sem venda.",
