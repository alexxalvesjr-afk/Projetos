...
async function main() {
  ...
  const organization = await db.organization.create({
    data: {
      ...
      email: "contato@dubossmotors.com.br",
      phone: "7130284500",
      whatsapp: "71988887777",
      addressLine: "Av. Santos Dumont, 1800",
      city: "Lauro de Freitas",
      state: "BA",
      postalCode: "42700-000",
      brandColor: "#DBA840",
      instagramUrl: "https://instagram.com/dubossmotors",
      facebookUrl: "https://facebook.com/dubossmotors",
      websiteSettings: {
        create: {
          heroHeadline: "Veículos premium e embarcações, com procedência de verdade.",
          heroSubheadline:
          ...
          metaTitle: "Duboss Motors — Veículos premium e embarcações",
          metaDescription:
            "Veículos premium revisados com garantia, laudo cautelar e transporte próprio para todo o Brasil. Confira o estoque da Duboss Motors.",
          published: true,
        },
      },
    },
  ...
  const teamSpec: {
    ...
    { name: "Marina Duarte", email: "owner@dubossmotors.com.br", role: "OWNER", jobTitle: "Sócia-fundadora", commissionRate: 0 },
    { name: "Ricardo Menezes", email: "admin@dubossmotors.com.br", role: "ADMIN", jobTitle: "Diretor de operações", commissionRate: 0 },
    { name: "Patrícia Lopes", email: "gerente@dubossmotors.com.br", role: "MANAGER", jobTitle: "Gerente comercial", commissionRate: 1 },
    { name: "Thiago Moraes", email: "thiago@dubossmotors.com.br", role: "SALESPERSON", jobTitle: "Consultor de vendas", commissionRate: 2.5 },
    { name: "Juliana Prado", email: "juliana@dubossmotors.com.br", role: "SALESPERSON", jobTitle: "Consultora de vendas", commissionRate: 2.5 },
    { name: "André Nogueira", email: "andre@dubossmotors.com.br", role: "SALESPERSON", jobTitle: "Consultor de vendas", commissionRate: 2.2 },
    { name: "Contabilidade Vega", email: "financeiro@dubossmotors.com.br", role: "VIEWER", jobTitle: "Contabilidade externa", commissionRate: 0 },
  ];
  ...
  await db.testimonial.createMany({
    data: [
      { organizationId: organization.id, authorName: "Fernanda Ribeiro", authorRole: "Comprou um Jeep Compass", content: "Segunda vez que compro na Duboss. Transparência total no laudo e o carro chegou impecável. Recomendo de olhos fechados.", rating: 5, position: 0 },
  ...
  await db.sitePage.create({
    data: {
      organizationId: organization.id,
      slug: "sobre",
      title: "Sobre a Duboss Motors",
      content:
        "<p>São mais de 19 anos no mercado automotivo premium. Nosso princípio é simples: só vendemos o veículo que colocaríamos a nossa própria família dentro.</p><p>Do esportivo ao blindado, do carro de uso diário à embarcação, cada unidade passa por inspeção completa — e sai com transporte próprio e seguro para qualquer lugar do Brasil.</p>",
      seoTitle: "Sobre a Duboss Motors — quem somos",
      seoDescription:
        "Conheça a história da Duboss Motors, referência em veículos premium e embarcações há mais de 19 anos.",
    },
  });
  ...
  console.log("\n✅  Seed concluído.\n");
  console.log("    Acesse com qualquer um destes usuários (senha: Duboss@2026):");
  for (const spec of teamSpec) {
